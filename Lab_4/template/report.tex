...
\title{\textbf{Laboratorio} \\ Extracción de características, Bolsa de Palabras Visuales, Detección de Movimiento y Seguimiento de Objetos}
...
\input{mainmatter/introduccion_ses_4}
...
\input{Lab_4/template/mainmatter/apartado_e}
