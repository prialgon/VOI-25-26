\chapter{Apartado A: \textbf{Detección de líneas rectas}}
\label{chapter:tarea_a}

\section*{Tarea A.1: Aplicación de Canny}
\phantomsection
\addcontentsline{toc}{section}{Tarea A.1: Aplicación de Canny}
...
\section*{Tarea A.2: Visualización de líneas}
\phantomsection
\addcontentsline{toc}{section}{Tarea A.2: Visualización de líneas}
...
\section*{Tarea A.3: Aplicación de transformada de Hough}
\phantomsection
\addcontentsline{toc}{section}{Tarea A.3: Aplicación de transformada de Hough} 
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.3\textwidth]{Lab_4/template/figures/football_lines.png}
