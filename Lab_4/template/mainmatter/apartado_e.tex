\chapter{Apartado E: \textbf{Filtro de Kalman para Seguimiento de Objetos}}
\label{chapter:tarea_e}

\section*{Tarea E.1: Configuración del Filtro de Kalman}
\phantomsection
\addcontentsline{toc}{section}{Tarea E.1: Configuración del Filtro de Kalman}
...
\section*{Tarea E.2: Predicción y Corrección del Estado}
\phantomsection
\addcontentsline{toc}{section}{Tarea E.2: Predicción y Corrección del Estado}
...
\vspace{5mm}
\begin{tcolorbox}[colback=gray!10, colframe=gray!30, coltitle=black, title=Pregunta E.1, halign=left]
¿Cómo afecta el valor de \texttt{transitionMatrix} a la predicción en el filtro de Kalman?
\end{tcolorbox}

\vspace{5mm}
\begin{tcolorbox}[colback=gray!10, colframe=gray!30, coltitle=black, title=Pregunta E.2, halign=left]
