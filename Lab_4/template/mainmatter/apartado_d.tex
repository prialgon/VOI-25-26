\chapter{Apartado D: \textbf{Flujo Óptico}}
\label{chapter:tarea_d}

\section*{Tarea D.1: Configuración del Flujo Óptico}
\phantomsection
\addcontentsline{toc}{section}{Tarea D.1: Configuración del Flujo Óptico}
...
\section*{Tarea D.2: Detección de Puntos de Interés}
\phantomsection
\addcontentsline{toc}{section}{Tarea D.2: Detección de Puntos de Interés}
...
\section*{Tarea D.3: Cálculo y Visualización del Flujo Óptico}
\phantomsection
\addcontentsline{toc}{section}{Tarea D.3: Cálculo y Visualización del Flujo Óptico}
