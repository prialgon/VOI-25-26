\chapter{Apartado C: \textbf{Sustracción de Fondo}}
\label{chapter:tarea_C}


\section*{Tarea C.1: Carga de vídeo}
\phantomsection
\addcontentsline{toc}{section}{Tarea C.1: Carga de vídeo}
...
\section*{Tarea C.2: Sustracción de fondo mediante diferencia de frames}
\phantomsection
\addcontentsline{toc}{section}{Tarea C.2: Sustracción de fondo mediante diferencia de frames}
...
\section*{Tarea C.3: Configuración de la Sustracción de Fondo con GMM}
\phantomsection
\addcontentsline{toc}{section}{Tarea C.3: Configuración de la Sustracción de Fondo con GMM}
...
\section*{Tarea C.4: Aplicación de la Sustracción de Fondo}
\phantomsection
\addcontentsline{toc}{section}{Tarea C.4: Aplicación de la Sustracción de Fondo}
