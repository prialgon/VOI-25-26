\chapter{Apartado B: \textbf{Detección de puntos de interés y Bolsa de palabras}}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.6\textwidth]{Lab_4/template/figures/FeatureMatch.png}
    \caption{Correspondencia de características entre una imagen y la misma alterada con OpenCV.}
    \label{fig:feat_match}
\end{figure}

\section*{B.1: Detección de puntos de interés}
\phantomsection
\addcontentsline{toc}{section}{B.1: Detección de puntos de interés}
...
\subsection*{Tarea B.1.1: Filtro gaussiano con OpenCV}
\phantomsection
\addcontentsline{toc}{subsection}{Tarea B.1.1: Filtro gaussiano con OpenCV}
...
\subsection*{Tarea B.1.2: Generación de espacio de escalas con imágenes gaussianas}
\addcontentsline{toc}{subsection}{Tarea B.1.2: Generación de espacio de escalas con imágenes gaussianas}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{Lab_4/template/figures/GaussianBlur.png}
    \caption{Resultados esperados de la generación de imágenes gaussianas}
    \label{fig:gauss_blur}
\end{figure}

\subsection*{Tarea B.1.3: Generación de diferencias de gaussianas}
\addcontentsline{toc}{subsection}{Tarea B.1.3: Generación de diferencias de gaussianas}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{Lab_4/template/figures/DoG.png}
    \caption{Resultados esperados de la generación de diferencias gaussianas}
    \label{fig:dog}
\end{figure}


\subsection*{Tarea B.1.4: Evaluación de extremos}
\addcontentsline{toc}{subsection}{Tarea B.1.4: Evaluación de extremos}
...
\subsection*{Tarea B.1.5: Localización de puntos de interés y orientación de los mismos}
\addcontentsline{toc}{subsection}{Tarea B.1.5: Localización de puntos de interés y orientación de los mismos}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.4\textwidth]{Lab_4/template/figures/KeypointDetect.png}
...
\subsection*{Tarea B.1.6: \textit{Pipeline} de generación de puntos de interés y descriptores}
\addcontentsline{toc}{subsection}{Tarea B.1.6: \textit{Pipeline} de generación de puntos de interés y descriptores}
...
\subsection*{Tarea B.1.7: Correspondencia de características entre imágenes}
\addcontentsline{toc}{subsection}{Tarea B.1.7: Correspondencia de características entre imágenes}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{Lab_4/template/figures/FeatureMatchMine.png}
...
\newpage
\section*{B.2: Bolsa de palabras}
\phantomsection
\addcontentsline{toc}{section}{B.2: Bolsa de palabras}
...
\subsection*{Tarea B.2.1: Carga de \textit{datasets} de entrenamiento y validación}
\addcontentsline{toc}{subsection}{Tarea B.2.1: Carga de \textit{datasets} de entrenamiento y validación}
...
\subsection*{Tarea B.2.2: Extracción de los descriptores}
\addcontentsline{toc}{subsection}{Tarea B.2.2: Extracción de los descriptores}
...
\subsection*{Tarea B.2.3: Creación del vocabulario}
\addcontentsline{toc}{subsection}{Tarea B.2.3: Creación del vocabulario}
...
\subsection*{Tarea B.2.4: Entrenamiento del clasificador}
\addcontentsline{toc}{subsection}{Tarea B.2.4: Entrenamiento del clasificador}
...
\subsection*{Tarea B.2.5: Inferencia en el dataset de entrenamiento}
\addcontentsline{toc}{subsection}{Tarea B.2.5: Inferencia en el dataset de entrenamiento}
...
\subsection*{Tarea B.2.6: Inferencia en el dataset de validación}
\addcontentsline{toc}{subsection}{Tarea B.2.6: Inferencia en el dataset de validación}
...
\begin{tcolorbox}[colback=gray!10, colframe=gray!30, coltitle=black, title=\textbf Pregunta B.2: En busca de los mejores parámetros, halign=left]
Al igual que ha iterado en la pregunta anterior con el número de palabras, itere con el resto de parámetros como el número de iteraciones para el K-Means, el número de iteraciones para el SVM, el extractor de caractrerísticas... Proporcione el código final con los parámetros de entrenamiento y los resultados obtenidos.
\end{tcolorbox}
