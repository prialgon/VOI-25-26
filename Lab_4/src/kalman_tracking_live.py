...
videopath = 'Lab_4\data\singleball.mp4'  # Path to the video file
cap = cv2.VideoCapture(videopath)  # Complete this line to read the video file

#TODO: Check if the video was successfully opened
if not cap.isOpened():
    print('Error: Could not open the video file') # Complete this line to read the video file  # not needed for video files
