\chapter{Apartado A: \textbf{Filtro Gaussiano y Detección de bordes: Sobel y Canny}}
...
\section*{Tarea A.1: Implementación de filtro Gausiano}
\phantomsection
\addcontentsline{toc}{section}{Tarea A.1: Implementación de filtro Gausiano}
...
\section*{Tarea A.2: Aplicación de filtro Gausiano}
\phantomsection
\addcontentsline{toc}{section}{Tarea A.2: Aplicación de filtro Gausiano}
...
\section*{Tarea A.3: Implementación de filtro Sobel}
\phantomsection
\addcontentsline{toc}{section}{Tarea A.3: Implementación de filtro Sobel}
...
\section*{Tarea A.4: Aplicación de filtro Sobel}
\phantomsection
\addcontentsline{toc}{section}{Tarea A.4: Aplicación de filtro Sobel}
...
\section*{Tarea A.5: Implementación de filtro Canny}
\phantomsection
...
\section*{Tarea A.6: Aplicación de filtro Canny}
\phantomsection
\addcontentsline{toc}{section}{Tarea A.6: Aplicación de filtro Canny}
