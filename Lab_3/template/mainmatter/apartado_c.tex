\chapter{Apartado C: \textbf{Detección de esquinas}}
\label{chapter:tarea_c}


\section*{Tarea C.1: Creación de carpeta de resultados}
\phantomsection
\addcontentsline{toc}{section}{Tarea C.1: Creación de carpeta de resultados}
...
\addcontentsline{toc}{section}{Tarea C.2: Carga de imágenes}
...
\addcontentsline{toc}{section}{Tarea C.3: Definición del método  Harris para detección de esquinas}
...
\section*{Tarea C.4: Aplicación de Harris}
\addcontentsline{toc}{section}{Tarea C.4: Aplicación de Harris}
...
\addcontentsline{toc}{section}{Tarea C.5: Definición del método  Shi-Tomasi para detección de esquinas}
...
\section*{Tarea C.6: Aplicación de Shi-Tomasi}
